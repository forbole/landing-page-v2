      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Forbole Limited, Flat 3B, Tontex
            Industrial Building, 2-4 Sheung Hei Street, San Po Kong, Kowloon,
            Hong Kong.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Forbole Official Website,
            accessible from{" "}
            <a href="https://www.forbole.com/" rel="noreferrer" target="_blank">
